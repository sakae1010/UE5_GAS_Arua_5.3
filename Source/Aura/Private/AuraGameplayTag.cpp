...
// DamageType Resistances ^^^^^^
	...
	*/
	...
	GameplayTags.Cooldown_Fire_FireBlast = GameplayTagsManager.AddNativeGameplayTag(
	...
	*/
	 ...
	 * GameplayCue 
	 */
	GameplayTags.GameplayCue_FireBlast = GameplayTagsManager.AddNativeGameplayTag(
